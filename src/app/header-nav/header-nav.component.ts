...
// import { LoginModal  } from '../modal/login/login-modal.component';
// import { RegisterModal  } from '../modal/register/register-modal.component';
//
...
export class HeaderNavComponent implements OnInit {
    ...
    //
    // showRegisterModal() {
    //     return this.modal.open(RegisterModal,
    //         overlayConfigFactory({ showClose: false, isBlocking: false}, BSModalContext));
    // }
